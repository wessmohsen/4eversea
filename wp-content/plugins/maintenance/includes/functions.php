...
function mtnc_accessibe_side() {
  ...
  $promo_text .= '<p><b>20% of people who visit your site can\'t use it properly</b> because they have a dissability. Making your site accessible is required by law and you can face heavy fines for not doing it.</p><p>By using the <a href="#" class="open-accessibe-upsell">accessiBe plugin</a> you can make your site accessible and WGAG & ADA compliant. This will not only save you from fines but instantly grow your audience.</p>';
...
function mtnc_accessibe_option() {
  if (is_plugin_active('accessibe/accessiebe.php')) {
    ...
    echo '<th><label for="accessibe_support">Web Accessibility</label></th>';
    echo '<td style="line-height: 1.5;">';
    echo '<input type="checkbox" id="accessibe_support" type="checkbox" value="1" class="skip-save">Your maintenance page is currently <b>not fully accessible for over 20% of visitors</b> with dissabilities.<br> Make your site accessible from day one and WGAG &amp; ADA compliant by installing the <a href="#" class="open-accessibe-upsell">accessiBe plugin.</a>';
    echo '</td>';
    echo '</tr>';
  }
} // mtnc_accessibe_option
