<?php
class TrendyTravel_Portfolio_Widget extends WP_Widget {
	#1.constructor
	function __construct() {
		...
		parent::__construct(false,TRENDYTRAVEL_THEME_NAME.esc_html__(' Portfolio','designthemes-core'),$widget_options);
	}
