		...
		$args = array(
		  ...
		  $trips_loop = new WP_Query( $args );
            ...
            <div class="div-table-row">
                ...
                <div  class="div-table-col"><?php the_field('currency', 'option'); echo' '; the_field('course_price');  ?></div>
                    ...
                    <div id="pop_booking_form" class="modal">
                        ...
                        <div class="pop_booking_body">
                            ...
                            <div class="wpb_column vc_column_container vc_col-sm-12 pop_short_desc">
                                <?php
                                $the_desc = get_field('course_short_desc');
                                echo mb_strimwidth($the_desc, 0, 101, "...");
                                ?>
                            </div>
                            ...
                            <div class="hotel-details">
                                ...
                                <div class="justify-content-between">
                                    ...
                                    <div class="wpb_column vc_column_container vc_col-sm-7">
                                        ...
                                        <p class="hotel-type">
                                            <a href="#" rel="tag"><?php echo $post_type_obj->labels->singular_name; ?></a>
                                        ...
                                        <div class="vc_column_container vc_col-sm-12">
                                            ...
                                            <?php if (get_field('course_duration')){ ?>
                                                <div class="course_info_block_cat vc_column_container wpb_column vc_col-sm-6">
                                                    <div class="inf_ico">
                                                        <img src="<?php echo $home_url; ?>/test/icons/duration_dark.png" title="<?php  _e('Duration', 'trendytravel'); ?>" >
                                                    </div>
                                                    <div class="inf_data">
                                                        <span class="inf_title"><strong><?php the_field('course_duration'); ?></strong></span>
                                            ...
                                            <?php if (get_field('course_equipment')){ ?>
                                                <div class="course_info_block_cat vc_column_container wpb_column vc_col-sm-6">
                                                    <div class="inf_ico">
                                                        <img src="<?php echo $home_url; ?>/test/icons/mask.png" title="<?php  _e('Equipment', 'trendytravel'); ?>" >
                                                    </div>
                                                    <div class="inf_data">
                                                        <span class="inf_title"><strong><?php the_field('course_equipment'); ?></strong></span>
                                                    </div>
                                                </div>
                                            <?php } ?>
                                        </div>
                                ...
                                <div class="hotel-thumb-meta">
                                    <div class="hotel-price"><?php  _e('Price', 'trendytravel'); ?><span><?php the_field('currency', 'option'); echo' '; the_field('course_price');  ?></span></div>
