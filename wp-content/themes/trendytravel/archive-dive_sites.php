...
?>
	<header id="header">
		...
		<section class="content-full-width" id="primary">
            <img loading="lazy" class="size-full" src="http://4eversea.test/wp-content/uploads/2021/01/header_001.jpg" alt="Top-Banner" width="1920" height="370">
			<div class="cpt_header_title">
				<div class="container">Dive Sites</div>
			</div>	
		</section>
